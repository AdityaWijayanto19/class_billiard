    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="hidden md:flex flex-row gap-2 md:gap-4 h-[500px] max-w-7xl mx-auto px-4">
            ...
            <div
                ...
                @endif
                <div class="absolute inset-0 {{ $isCenterCard ? 'bg-gradient-to-t from-black/80 via-transparent to-transparent' : 'bg-black/60 group-hover:bg-transparent transition-colors duration-500' }}"></div>
                <div class="absolute bottom-0 left-0 w-full {{ $isCenterCard ? 'p-8' : 'p-6 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100' }} transition-all duration-500 bg-gradient-to-t from-black/90 to-transparent">

...
@php
     ...
     * Mengambil data secara langsung untuk menghindari masalah cache di production.
     */
    try {
...
<section id="team" class="py-32 bg-[#050505] relative overflow-hidden">
    ...
    <!-- LUXURY FLOW BACKGROUND (Tanpa Lingkaran Kuning Kaku) -->
    <div class="absolute inset-0 z-0 pointer-events-none">
        ...
        <!-- Glow Ambient Lembut (Bukan Bulatan) -->
...
<style>
    /* Social Button dengan Glow Emas */
    .social-btn {
    ...
    /* Font Luxury Fallback */
    .font-serif {
        font-family: 'Playfair Display', serif; /* Pastikan Google Font ini di-load di layout */
    }
</style>
@endif
// If an inline dapur script already initialized, skip executing this external file
if (window && window.__DapurInlineInitialized) {
    try { console.debug('public/js/dapur.js: inline dapur present, skipping external script'); } catch (e) {}
} else {
    // Wrap full behavior inside DOMContentLoaded
